...
export const metadata: Metadata = {
  title: "Кейсы и отзывы клиентов — реальные результаты финансовой помощи",
  description:
    "Реальные истории одобрения кредитов, оформления ипотеки и возврата страховок. Смотрите результаты наших клиентов!",
  keywords: [
    "отзывы о кредитном брокере",
    "реальные кейсы одобрения кредита",
    "истории одобрения ипотеки",
    "результаты исправления кредитной истории",
    "отзывы возврат страховки по кредиту",
  ],
        ...
        <ScrollReveal>
          <div className="text-center mb-14">
            ...
            <p className="mt-4 text-text-muted text-lg max-w-xl mx-auto">
              Истории одобрения кредитов, возврата страховок и другие результаты финансовой помощи
            </p>
          </div>
        </ScrollReveal>
